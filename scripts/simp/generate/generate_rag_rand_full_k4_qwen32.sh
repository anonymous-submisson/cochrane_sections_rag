...
case $MODEL_TYPE in
    qwen-32b) MODEL_ALIAS="qwen-32b"; MODEL_SHORT_NAME="RAG-rand-full-Qwen2.5-32B" ;;
    gemma-3-27b) MODEL_ALIAS="gemma-3-27b"; MODEL_SHORT_NAME="RAG-rand-full-Gemma-3-27B" ;;
    llama-70b) MODEL_ALIAS="llama-70b"; MODEL_SHORT_NAME="RAG-rand-full-Llama-3.1-70B" ;;
    *)
...
echo "K: $K  POOL: cochrane-sections train  RETRIEVAL: random  EXAMPLE: whole"
